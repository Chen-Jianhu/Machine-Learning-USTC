...
# @Last Modified time: 2019-01-05 16:25:20
...
def pre_processing_data():
	...
	for i in range(len(iris_data)):
		...
		if sepal_length < sepal_length_min+(sepal_length_max-sepal_length_min)/4:
			sepal_length = 1
		elif sepal_length >= sepal_length_min+(sepal_length_max-sepal_length_min)/4 and sepal_length < sepal_length_min+2*(sepal_length_max-sepal_length_min)/4:
			sepal_length = 2
		elif sepal_length >= sepal_length_min+2*(sepal_length_max-sepal_length_min)/4 and sepal_length < sepal_length_min+3*(sepal_length_max-sepal_length_min)/4:
			sepal_length = 3
		...
		if sepal_width < sepal_width_min+(sepal_width_max-sepal_width_min)/4:
			sepal_width = 1
		elif sepal_width >= sepal_width_min+(sepal_width_max-sepal_width_min)/4 and sepal_width < sepal_width_min+2*(sepal_width_max-sepal_width_min)/4:
			sepal_width = 2
		elif sepal_width >= sepal_width_min+2*(sepal_width_max-sepal_width_min)/4 and sepal_width < sepal_width_min+3*(sepal_width_max-sepal_width_min)/4:
			sepal_width = 3
		...
		if petal_length < petal_length_min+(petal_length_max-petal_length_min)/4:
			petal_length = 1
		elif petal_length >= petal_length_min+(petal_length_max-petal_length_min)/4 and petal_length < petal_length_min+2*(petal_length_max-petal_length_min)/4:
			petal_length = 2
		elif petal_length >= petal_length_min+2*(petal_length_max-petal_length_min)/4 and petal_length < petal_length_min+3*(petal_length_max-petal_length_min)/4:
			petal_length = 3
		...
		if petal_width < petal_width_min+(petal_width_max-petal_width_min)/4:
			petal_width = 1
		elif petal_width >= petal_width_min+(petal_width_max-petal_width_min)/4 and petal_width < petal_width_min+2*(petal_width_max-petal_width_min)/4:
			petal_width = 2
		elif petal_width >= petal_width_min+2*(petal_width_max-petal_width_min)/4 and petal_width < petal_width_min+3*(petal_width_max-petal_width_min)/4:
			petal_width = 3
...
def main():
	...
	# 构造决策树
	iris_tree = createTree(train_set, feature, criterion='C4.5')
	# print(iris_tree)
